...
#include "OGL.h"														// Header File For The NeHeGL Basecode
#include "settings.h"
#include "debugout.h"
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	application.className = "Bomberman";								// Application Class Name
	...
	window.init.title			= "Bomberman";		                	// Window Title
	...
	while (g_isProgramLooping)											// Loop Until WM_QUIT Is Received
	{
		...
		if (CreateWindowGL (&window) == TRUE)							// Was Window Creation Successful?
		{
			...
			{
				// Failure
				MessageBox (HWND_DESKTOP, "Initialization failed. Please consult debug.log.", "Error", MB_OK | MB_ICONEXCLAMATION);
				TerminateApplication (&window);							// Close Window, This Will Handle The Shutdown
			}
			else														// Otherwise (Start The Message Pump)
			{	// Initialize was a success
			    debugoutput("Program running.");
